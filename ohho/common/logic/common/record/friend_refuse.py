...
from ohho.common.logic.ohho.detail_constant import ADD_FRIEND_REFUSE_FAILED
from ohho.common.logic.ohho.detail_constant import ADD_FRIEND_REFUSE_SUCCESS
from ohho.common.logic.ohho.detail_constant import FRIEND_REFUSE_NOT_EXIST
...
from ohho.common.logic.ohho.detail_constant import VALID_FRIEND_REFUSE_NOT_EXIST


class FriendRefuse(object):
    def __init__(self):
    ...
    def get(self, apply_id):
        ...
        if apply_id:
            ...
            if query:
                ...
                return query
                # else:
                #     OHHOLog.print_log(VALID_FRIEND_REFUSE_NOT_EXIST)
            else:
                OHHOLog.print_log(FRIEND_REFUSE_NOT_EXIST)
        else:
    ...
    def add(self, apply_id, data_dict=dict()):
        ...
        if not refuse:
            ...
            if success:
                OHHOLog.print_log(ADD_FRIEND_REFUSE_SUCCESS)
                return self.get(apply_id)
            else:
                OHHOLog.print_log(ADD_FRIEND_REFUSE_FAILED)
        else:
