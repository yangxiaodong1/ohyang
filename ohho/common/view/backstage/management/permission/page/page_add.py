...
class BackstagePageAddHandler(BaseHandler):
    ...
    def post(self):
        ...
        return self.redirect(PERMISSION_PAGE_BACKSTAGE_ADD_URL)

    # @permission
    @backstage_authenticate
    def get(self):
        return self.render(PERMISSION_PAGE_BACKSTAGE_ADD_HTML,
