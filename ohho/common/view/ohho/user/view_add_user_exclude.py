...
class AddUserExcludeHandler(ViewOHHOBase):
    @authenticate
    def post(self):
        the_post = Post()
        ...
        exclude_user_ids = the_post.get_user_extension_exclude(self)

        instance = LogicAddUserExclude()
        result = instance.add_user_exclude(user_id, exclude_user_ids)
