from DB.mysql.models.ohho.record.model_ohho_record_match_condition import OHHORecordMatchCondition as model
...
class DBOHHORecordMatchCondition(DBBase):
    def __init__(self):
        super(DBOHHORecordMatchCondition, self).__init__(model)
