...
class DBOHHOIMUserRelation(DBBase):
    def __init__(self, index=0):
        super(DBOHHOIMUserRelation, self).__init__(OHHOIMUserRelation, index)

    def get_by_apply_id_is_not_none(self, query):
        return Operation.is_not(query, self.model.apply_id, None)
