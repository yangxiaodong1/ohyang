from DB.mysql.models.ohho.user.model_ohho_staff_accuracy_extension import  OHHOStaffAccuracyExtension
...
class DBOHHOStaffAccuracyExtension(DBBase):
    def __init__(self, index=0):
        super(DBOHHOStaffAccuracyExtension, self).__init__(OHHOStaffAccuracyExtension, index)
...
if __name__ == "__main__":
    instance = DBOHHOStaffAccuracyExtension()
