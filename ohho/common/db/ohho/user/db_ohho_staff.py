from DB.mysql.models.ohho.user.model_ohho_staff import OHHOStaff
...
class DBOHHOStaff(DBBase):
    def __init__(self, index=0):
        super(DBOHHOStaff, self).__init__(OHHOStaff, index)
    ...
    def get_valid(self, query):
        return super(DBOHHOStaff, self).get_valid(query, True)

    def get_invalid(self, query):
        return super(DBOHHOStaff, self).get_invalid(query, True)
    ...
    def delete(self, instance):
        return super(DBOHHOStaff, self).delete(instance, True)

    def restore(self, instance):
        return super(DBOHHOStaff, self).restore(instance, True)


if __name__ == "__main__":
    instance = DBOHHOStaff()
