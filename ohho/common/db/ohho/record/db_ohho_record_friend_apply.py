...
from ohho.common.logic.common.record.constant import VALID_INTERVAL_MILLISECOND, VALID_FRIEND_INTERVAL_MILLISECOND
...
class DBOHHORecordFriendApply(DBBase):
    def __init__(self, index=0):
        super(DBOHHORecordFriendApply, self).__init__(model, index)
